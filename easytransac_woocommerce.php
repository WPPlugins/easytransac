...
//			);
		...
		function process_payment($order_id)
		{
			...
			$version_string = sprintf('WooCommerce 2.1 [cURL %s, OpenSSL %s, HTTP%s]', $curl_info_string, $openssl_info_string, $https_info_string);
...
//			$this->_debug(var_export($_POST, true));
